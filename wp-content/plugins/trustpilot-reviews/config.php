...
define( 'TRUSTPILOT_MASTER_FIELD', 'master_settings_field' );
...
define( 'TRUSTPILOT_WP_PREVIEW_CSS', 'PreviewWPCssUrl' );
define( 'TRUSTPILOT_PLUGIN_URL', 'https://ecommplugins-pluginrepo.trustpilot.com/woocommerce/trustpilot.zip' );
