<?php
/**
 * Product variant (variation product) attributes select
 *
 * This template can be overridden by copying it to yourtheme/checkout-upsell-woocommerce/products/attributes-select.php.
 *
...
<div class="cuw-attributes-section">
    <select class="variant-select" style="display: none;"
        ...
        <option value=""
                ...
                data-stock_qty="<?php echo esc_attr($product['stock_qty']); ?>"
