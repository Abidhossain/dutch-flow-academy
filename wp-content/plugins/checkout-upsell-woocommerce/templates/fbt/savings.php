<?php
/**
 * Frequently bought together total savings amount label
 *
 * This template can be overridden by copying it to yourtheme/checkout-upsell-woocommerce/fbt/savings.php.
 *
...
if (!empty($product)) {
    ...
    <span class="cuw-badge"
          ...
          style="background: limegreen; color: white; line-height: 1; padding: 4px 6px; font-size: 90%; <?php echo !$display_product_badge || empty($save_text) ? 'display: none;' : ''; ?>">
