...
<ul>
    ...
    <li>
        <strong>Shipping Classes Support</strong><br>
...
* WBS6 Preview: fix the Drop action not being saved correctly when it's set to 'all' and the Products column is not 'any'.
* WBS6 Preview: fix the Drop 'all' and Finish actions not marking the dropped items as matched causing the shipping method to be declined.

= 5.7.1 =
* Tested with WooCommerce 8.5.
* WBS6 preview: fix Action set to Finish every time Charge edited.
* WBS6 preview: fix "Cannot unpack array with string keys" for PHP 7.x.
...
* WBS6 preview: add Action column
* WBS6 preview: fix conditions not being re-checked for a package in split-shipping mode
* WBS6 preview: disable the custom Ctrl/Cmd+C handler when some text is selected on the page
* WBS6 preview: UI tweaks

= 5.6.3 =
* Tested with WordPress 6.4, WooCommerce 8.3.
* Drop PHP 7.1 support.
* WBS6 preview: improve PHP pre-8.0 compatibility.

= 5.6.2 =
* Tested with WooCommerce 8.2.

= 5.6.1 =
* WBS6 preview: change the meaning of the 'all' checkbox in the destination editor from 'all available' to 'all visible'
* WBS6 preview: display kg, cm, and mm in a compact way.
...
= 5.3.27 =
* Prevent updating to the incorrect version.
