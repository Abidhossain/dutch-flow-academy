...
use WbsVendors\Dgm\Shengine\Interfaces\IPackage;
...
class ShippingMethod extends WC_Shipping_Method
{
    ...
    private static function getAllShippingClasses()
    {
        return array_merge(
            [[
                'id' => IPackage::NONE_VIRTUAL_TERM_ID,
                'name' => 'No shipping class',
                'slug' => '',
            ]],
            Arrays::map(WC()->shipping()->get_shipping_classes(), static function(WP_Term $term) {
