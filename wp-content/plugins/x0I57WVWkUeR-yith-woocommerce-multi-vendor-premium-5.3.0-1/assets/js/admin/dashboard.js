...
if (true) {
  /* unused reexport */ __webpack_require__(727);
} else {}
...
/* global yith_wcmv_dashboard */
var NAMESPACE = yith_wcmv_dashboard.namespace;
var MAX_PER_PAGE = 100;
var PER_PAGE_SEARCH = yith_wcmv_dashboard.perPageSearch;
var PANEL_URL = yith_wcmv_dashboard.baseUrl;
var IS_VENDOR_DASHBOARD = yith_wcmv_dashboard.isVendorDashboard;
var IS_LEGACY_DASHBOARD = yith_wcmv_dashboard.isLegacyDashboard;
...
// EXTERNAL MODULE: ./node_modules/react-router-dom-legacy/node_modules/react-is/index.js
var react_is = __webpack_require__(574);
...
;// CONCATENATED MODULE: ./node_modules/react-router-dom-legacy/node_modules/react-router/esm/react-router.js
...
var MemoryRouter = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    return /*#__PURE__*/external_React_default().createElement(react_router_Router, {
...
var StaticRouter = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/external_React_default().createElement(react_router_Router, extends_extends({}, rest, {
      history: history,
...
var react_router_useContext = (external_React_default()).useContext;
function useHistory() {
  if (false) {}
...
var getVendorLabels = getRequestByIdString(NAMESPACE + '/vendors', function (vendor) {
  return {
    key: vendor.id,
    label: vendor.name
  };
});
var vendorsChartData = new asyncStatsRequest('vendors');
var vendorsTableData = new asyncReportsRequest('vendors');
...
var vendor = {
  ...
  options: function options(search) {
    ...
    return external_wp_apiFetch_default()({
      path: (0,external_wp_url_namespaceObject.addQueryArgs)("".concat(NAMESPACE, "/vendors"), query)
    });
  },
  ...
  getOptionKeywords: function getOptionKeywords(option) {
    return [option.name, option.user_email];
  },
...
if (!IS_VENDOR_DASHBOARD) {
  adminCharts = [{
    key: 'commissions_store_net_total',
    label: (0,external_wp_i18n_namespaceObject._x)('Total net earnings from vendors', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
    type: 'currency'
  }, {
    key: 'commissions_store_gross_total',
    label: (0,external_wp_i18n_namespaceObject._x)('Total earnings from vendors', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
    type: 'currency'
  }, {
    key: 'orders_count',
    label: (0,external_wp_i18n_namespaceObject._x)('Orders', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
    type: 'number'
  }];
}
var filtersConfig = (0,external_wp_hooks_namespaceObject.applyFilters)('yith_wcmv_admin_dashboard_report_filters', IS_VENDOR_DASHBOARD ? [] : [{
  label: (0,external_wp_i18n_namespaceObject._x)('Show', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
  ...
  filters: [{
    label: (0,external_wp_i18n_namespaceObject._x)('All vendors', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
    value: 'all'
  }, {
    label: (0,external_wp_i18n_namespaceObject._x)('Single vendor', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
    value: 'select_vendor',
    ...
    subFilters: [{
      ...
      settings: {
        type: 'custom',
        param: 'vendors',
        autocompleter: vendor,
        getLabels: getVendorLabels,
        labels: {
          placeholder: (0,external_wp_i18n_namespaceObject._x)('Search for a vendor', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
          button: (0,external_wp_i18n_namespaceObject._x)('Single vendor', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors')
        }
      }
    }]
  }, {
    label: (0,external_wp_i18n_namespaceObject._x)('Comparison', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
    value: 'compare_vendors',
    chartMode: 'item-comparison',
    settings: {
      type: 'custom',
      param: 'vendors',
      ...
      getLabels: getVendorLabels,
      labels: {
        helpText: (0,external_wp_i18n_namespaceObject._x)('Select at least two vendors to compare', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
        placeholder: (0,external_wp_i18n_namespaceObject._x)('Search for vendors to compare', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
        title: (0,external_wp_i18n_namespaceObject._x)('Compare vendors', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors'),
        update: (0,external_wp_i18n_namespaceObject._x)('Compare', '[DASHBOARD] Filters', 'yith-woocommerce-product-vendors')
      }
    }
  }]
}]);
var chartsConfig = (0,external_wp_hooks_namespaceObject.applyFilters)('yith_wcmv_admin_dashboard_report_charts', [{
  key: 'commissions_count',
  label: (0,external_wp_i18n_namespaceObject._x)('Commissions', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
  type: 'number'
}, {
  key: 'commissions_total_earnings',
  label: (0,external_wp_i18n_namespaceObject._x)('Total commissions', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
  type: 'currency'
}, {
  key: 'commissions_total_pending',
  label: (0,external_wp_i18n_namespaceObject._x)('Pending commissions', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
  type: 'currency'
}, {
  key: 'commissions_total_paid',
  label: (0,external_wp_i18n_namespaceObject._x)('Paid commissions', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
  type: 'currency'
}, {
  key: 'commissions_total_refunds',
  label: (0,external_wp_i18n_namespaceObject._x)('Refunded commissions', '[DASHBOARD] Chart name', 'yith-woocommerce-product-vendors'),
  type: 'currency'
}].concat(_toConsumableArray(adminCharts)));
...
var _wc, _wc$wcSettings;


var formatCurrency = external_wc_currency_default()(typeof ((_wc = wc) === null || _wc === void 0 ? void 0 : (_wc$wcSettings = _wc.wcSettings) === null || _wc$wcSettings === void 0 ? void 0 : _wc$wcSettings.CURRENCY) !== 'undefined' ? wc.wcSettings.CURRENCY : {}).formatAmount;
...
var formatTimeDiff = function formatTimeDiff(timeDiff) {
  var thresholds = [{
    ...
    label: (0,external_wp_i18n_namespaceObject._x)('y', '[DASHBOARD] Time diff', 'yith-woocommerce-product-vendors')
  }, {
    seconds: MONTH_IN_SECONDS,
    label: (0,external_wp_i18n_namespaceObject._x)('mo', '[DASHBOARD] Time diff', 'yith-woocommerce-product-vendors')
  }, {
    seconds: WEEK_IN_SECONDS,
    label: (0,external_wp_i18n_namespaceObject._x)('w', '[DASHBOARD] Time diff', 'yith-woocommerce-product-vendors')
  }, {
    seconds: DAY_IN_SECONDS,
    label: (0,external_wp_i18n_namespaceObject._x)('d', '[DASHBOARD] Time diff', 'yith-woocommerce-product-vendors')
  }, {
    seconds: HOUR_IN_SECONDS,
    label: (0,external_wp_i18n_namespaceObject._x)('h', '[DASHBOARD] Time diff', 'yith-woocommerce-product-vendors')
  }, {
    seconds: MINUTE_IN_SECONDS,
    label: (0,external_wp_i18n_namespaceObject._x)('m', '[DASHBOARD] Time diff', 'yith-woocommerce-product-vendors')
  }, {
    seconds: 0,
    label: (0,external_wp_i18n_namespaceObject._x)('s', '[DASHBOARD] Time diff', 'yith-woocommerce-product-vendors')
  }];
...
var DashboardChart = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DashboardChart, [{
    ...
    value: function getChartMode() {
      ...
      if ('compare_vendors' === (query === null || query === void 0 ? void 0 : query.filter) && !!(query !== null && query !== void 0 && query.vendors)) {
    ...
    value: function render() {
      var _this$props5 = this.props,
        ...
        emptyMessage = (0,external_wp_i18n_namespaceObject._x)('No data available', '[DASHBOARD] Empty chart message', 'yith-woocommerce-product-vendors');
...
var DashboardStats = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DashboardStats, [{
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return vendorsChartData.getFormattedData(this.getQueryArgs(query), 'primary');
            case 3:
              _context.t0 = _context.sent;
              _context.next = 6;
              return vendorsChartData.getFormattedData(this.getQueryArgs(query), 'secondary');
            case 6:
    ...
    value: function getQueryArgs(query) {
      var queryArgs = query;
      if ('compare_vendors' === query.filter) {
        queryArgs.segmentby = 'vendor';
      }
      return queryArgs;
    }
  }, {
...
var adminLeaderboards = {
  products: {
    title: (0,external_wp_i18n_namespaceObject._x)('Top products', '[DASHBOARD] Products leaderboard', 'yith-woocommerce-product-vendors'),
    columns: [{
      label: (0,external_wp_i18n_namespaceObject._x)('Product', '[DASHBOARD] Products leaderboard', 'yith-woocommerce-product-vendors'),
      key: 'product',
      isSortable: false
    }, {
      label: (0,external_wp_i18n_namespaceObject._x)('Total commissions', '[DASHBOARD] Products leaderboard', 'yith-woocommerce-product-vendors'),
      key: 'commissions_total_earnings',
      type: 'currency',
      "default": 0,
      isSortable: false
...
if (!IS_VENDOR_DASHBOARD) {
  adminLeaderboards.products.columns.push({
    label: (0,external_wp_i18n_namespaceObject._x)('Earnings generated', '[DASHBOARD] Products leaderboard', 'yith-woocommerce-product-vendors'),
    key: 'commissions_store_gross_total',
    type: 'currency',
    "default": 0,
    isSortable: false
  });
  adminLeaderboards.vendors = {
    title: (0,external_wp_i18n_namespaceObject._x)('Top vendors', '[DASHBOARD] Vendors leaderboard', 'yith-woocommerce-product-vendors'),
    columns: [{
      label: (0,external_wp_i18n_namespaceObject._x)('Vendor', '[DASHBOARD] Vendors leaderboard', 'yith-woocommerce-product-vendors'),
      key: 'vendor',
      isSortable: false
    }, {
      label: (0,external_wp_i18n_namespaceObject._x)('Total commissions', '[DASHBOARD] Vendors leaderboard', 'yith-woocommerce-product-vendors'),
      key: 'commissions_total_earnings',
      type: 'currency',
      "default": 0,
      isSortable: false
    }, {
      label: (0,external_wp_i18n_namespaceObject._x)('Earnings generated', '[DASHBOARD] Vendors leaderboard', 'yith-woocommerce-product-vendors'),
      key: 'commissions_store_gross_total',
      type: 'currency',
      "default": 0,
      isSortable: false
...
var leaderboards = (0,external_wp_hooks_namespaceObject.applyFilters)('yith_wcmv_admin_dashboard_report_leaderboards', adminLeaderboards);
...
var DashboardLeaderboard = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DashboardLeaderboard, [{
    ...
    key: "formatUrl",
    value: function formatUrl(query) {
      var url = new URL(document.location.href);
      var _iterator3 = DashboardLeaderboard_createForOfIteratorHelper(query),
        _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          var q = _step3.value;
          url.searchParams.set(q.name, q.value);
        }
      } catch (err) {
        _iterator3.e(err);
      } finally {
    ...
    value: function formatCell(column, row) {
      ...
      switch (column === null || column === void 0 ? void 0 : column.key) {
        case 'vendor':
          var vendorName = row === null || row === void 0 ? void 0 : (_row$extended_info = row.extended_info) === null || _row$extended_info === void 0 ? void 0 : _row$extended_info.name,
            vendorAvatar = row === null || row === void 0 ? void 0 : (_row$extended_info2 = row.extended_info) === null || _row$extended_info2 === void 0 ? void 0 : _row$extended_info2.avatar,
            vendorEmail = row === null || row === void 0 ? void 0 : (_row$extended_info3 = row.extended_info) === null || _row$extended_info3 === void 0 ? void 0 : _row$extended_info3.email,
            vendorUrl = this.formatUrl([{
              name: 'filter',
              value: 'single_vendor'
            }, {
              name: 'vendors',
            ...
            vendorMailTo = "mailto:".concat(vendorEmail);
          value = row.id;
          display = /*#__PURE__*/React.createElement(external_wp_element_namespaceObject.Fragment, null, /*#__PURE__*/React.createElement("img", {
            ...
            href: vendorUrl
          }, vendorName), /*#__PURE__*/React.createElement("small", {
  ...
  _createClass(DashboardLeaderboards, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
        path = _this$props.path,
        query = _this$props.query,
        leaderboardsItems = ['products', 'vendors'].filter(function (item) {
          return typeof (leaderboards === null || leaderboards === void 0 ? void 0 : leaderboards[item]) != 'undefined';
        }),
...
;// CONCATENATED MODULE: ./assets/js/admin/src/dashboard/components/legacy/DashboardController.jsx
...
/* harmony default export */ const legacy_DashboardController = (DashboardController);
;// CONCATENATED MODULE: ./assets/js/admin/src/dashboard/components/legacy/Dashboard.jsx
...
var Dashboard = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Dashboard, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/external_React_default().createElement(Switch, null, /*#__PURE__*/external_React_default().createElement(Route, {
        key: "/",
        path: "/",
        exact: true,
        render: function render(props) {
          return /*#__PURE__*/external_React_default().createElement(legacy_DashboardController, extends_extends({
...
;// CONCATENATED MODULE: ./node_modules/react-router/node_modules/history/index.js
...
function node_modules_history_createBrowserHistory(options) {
  if (options === void 0) {
    options = {};
  }
  ...
  function createHref(to) {
    return typeof to === 'string' ? to : node_modules_history_createPath(to);
  ...
  function getNextLocation(to, state) {
    ...
    return readOnly(_extends({
      ...
      hash: '',
      search: ''
    }, typeof to === 'string' ? node_modules_history_parsePath(to) : to, {
      state: state,
      key: createKey()
    }));
  }
...
function node_modules_history_createHashHistory(options) {
  if (options === void 0) {
    options = {};
  }
  ...
  function getIndexAndLocation() {
    var _parsePath = node_modules_history_parsePath(window.location.hash.substr(1)),
  ...
  window.addEventListener(HashChangeEventType, function () {
    ...
    if (node_modules_history_createPath(nextLocation) !== node_modules_history_createPath(location)) {
      handlePop();
    }
  });
  var action = Action.Pop;
  ...
  function createHref(to) {
    return getBaseHref() + '#' + (typeof to === 'string' ? to : node_modules_history_createPath(to));
  }
...
function node_modules_history_createMemoryHistory(options) {
  if (options === void 0) {
    options = {};
  }
  ...
  var entries = initialEntries.map(function (entry) {
    var location = readOnly(_extends({
      ...
      state: null,
      key: createKey()
    }, typeof entry === 'string' ? node_modules_history_parsePath(entry) : entry));
     false ? 0 : void 0;
    return location;
  });
  var index = history_clamp(initialIndex == null ? entries.length - 1 : initialIndex, 0, entries.length - 1);
  var action = Action.Pop;
  ...
  function go(delta) {
    var nextIndex = history_clamp(index + delta, 0, entries.length - 1);
    var nextAction = Action.Pop;
...
function node_modules_history_createPath(_ref) {
...
const NavigationContext = /*#__PURE__*/(0,external_React_namespaceObject.createContext)(null);

if (false) {}

const LocationContext = /*#__PURE__*/(0,external_React_namespaceObject.createContext)(null);

if (false) {}

const RouteContext = /*#__PURE__*/(0,external_React_namespaceObject.createContext)({
  outlet: null,
  matches: []
});
...
function matchRoutes(routes, locationArg, basename) {
  ...
  let location = typeof locationArg === "string" ? node_modules_history_parsePath(locationArg) : locationArg;
  let pathname = node_modules_react_router_stripBasename(location.pathname || "/", basename);
...
function matchRouteBranch(branch, pathname) {
  ...
  for (let i = 0; i < routesMeta.length; ++i) {
    ...
    let match = react_router_matchPath({
 ...
 */
function react_router_matchPath(pattern, pathname) {
  ...
  let [matcher, paramNames] = react_router_compilePath(pattern.path, pattern.caseSensitive, pattern.end);
...
function react_router_compilePath(path, caseSensitive, end) {
...
function resolvePath(to, fromPathname) {
  ...
  let pathname = toPathname ? toPathname.startsWith("/") ? toPathname : react_router_resolvePathname(toPathname, fromPathname) : fromPathname;
  return {
    pathname,
...
function react_router_resolvePathname(relativePath, fromPathname) {
...
function node_modules_react_router_stripBasename(pathname, basename) {
...
function useInRouterContext() {
  return (0,external_React_namespaceObject.useContext)(LocationContext) != null;
}
/**
...
function node_modules_react_router_useLocation() {
  !useInRouterContext() ?  false ? 0 : react_router_invariant(false) : void 0;
  return (0,external_React_namespaceObject.useContext)(LocationContext).location;
}
/**
...
function useMatch(pattern) {
  ...
  let {
    pathname
  } = node_modules_react_router_useLocation();
  return (0,external_React_namespaceObject.useMemo)(() => react_router_matchPath(pattern, pathname), [pathname, pattern]);
}
/**
...
function react_router_useParams() {
  let {
    matches
  } = (0,external_React_namespaceObject.useContext)(RouteContext);
...
function useRoutes(routes, locationArg) {
  ...
  let locationFromContext = node_modules_react_router_useLocation();
  let location;

  if (locationArg) {
    var _parsedLocationArg$pa;

    let parsedLocationArg = typeof locationArg === "string" ? node_modules_history_parsePath(locationArg) : locationArg;
...
function _renderMatches(matches, parentMatches) {
  ...
  return matches.reduceRight((outlet, match, index) => {
    return /*#__PURE__*/(0,external_React_namespaceObject.createElement)(RouteContext.Provider, {
 ...
 */
function react_router_MemoryRouter(_ref) {
  let {
    basename,
    children,
    initialEntries,
  ...
  return /*#__PURE__*/createElement(node_modules_react_router_Router, {
    basename: basename,
    children: children,
 ...
 */
function react_router_Route(_props) {
 ...
 */
function node_modules_react_router_Router(_ref3) {
  let {
  ...
  let navigationContext = (0,external_React_namespaceObject.useMemo)(() => ({
    basename,
    navigator,
    static: staticProp
  ...
  if (typeof locationProp === "string") {
    locationProp = node_modules_history_parsePath(locationProp);
  }
  ...
  let location = (0,external_React_namespaceObject.useMemo)(() => {
    let trailingPathname = node_modules_react_router_stripBasename(pathname, basename);
  ...
  return /*#__PURE__*/(0,external_React_namespaceObject.createElement)(NavigationContext.Provider, {
    value: navigationContext
  }, /*#__PURE__*/(0,external_React_namespaceObject.createElement)(LocationContext.Provider, {
    children: children,
    value: {
      location,
      navigationType
...
function createRoutesFromChildren(children) {
  let routes = [];
  external_React_namespaceObject.Children.forEach(children, element => {
    if (! /*#__PURE__*/(0,external_React_namespaceObject.isValidElement)(element)) {
    ...
    !(element.type === react_router_Route) ?  false ? 0 : react_router_invariant(false) : void 0;
    let route = {
...
function HistoryRouter(_ref3) {
  ...
  (0,external_React_namespaceObject.useLayoutEffect)(() => history.listen(setState), [history]);
  return /*#__PURE__*/(0,external_React_namespaceObject.createElement)(node_modules_react_router_Router, {
    basename: basename,
    children: children,
    location: state.location,
    navigationType: state.action,
...
const Link = /*#__PURE__*/(/* unused pure expression or super */ null && (forwardRef(function LinkWithRef(_ref4, ref) {
  let {
    ...
    to
      ...
      rest = react_router_dom_objectWithoutPropertiesLoose(_ref4, _excluded);
...
function components_DashboardController_createSuper(Derived) { var hasNativeReflectConstruct = components_DashboardController_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function components_DashboardController_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var DashboardRoutedController = function DashboardRoutedController(props) {
  var location = node_modules_react_router_useLocation();
  var match = useMatch(location.pathname);
  var params = react_router_useParams();
  var matchProp = {
    params: params,
    url: match.pathname
  };
  ...
  return /*#__PURE__*/external_React_default().createElement(DashboardController_DashboardController, props);
};
var DashboardController_DashboardController = /*#__PURE__*/function (_Component) {
  _inherits(DashboardController, _Component);
  var _super = components_DashboardController_createSuper(DashboardController);
  function DashboardController() {
    var _this;
    _classCallCheck(this, DashboardController);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
...
function components_Dashboard_createSuper(Derived) { var hasNativeReflectConstruct = components_Dashboard_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function components_Dashboard_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }





var Dashboard_Dashboard = /*#__PURE__*/function (_Component) {
  _inherits(Dashboard, _Component);
  var _super = components_Dashboard_createSuper(Dashboard);
  function Dashboard() {
    _classCallCheck(this, Dashboard);
    return _super.apply(this, arguments);
  }
  _createClass(Dashboard, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/external_React_default().createElement(HistoryRouter, {
        ...
        basename: basename
      }, /*#__PURE__*/external_React_default().createElement(react_router_Route, {
        key: "/",
        path: "/",
        exact: true,
...
if (IS_LEGACY_DASHBOARD) {
  (0,external_ReactDOM_namespaceObject.render)( /*#__PURE__*/React.createElement(Dashboard, null), document.getElementById('yith-wcmv-dashboard-root'));
} else {
  (0,external_ReactDOM_namespaceObject.render)( /*#__PURE__*/React.createElement(Dashboard_Dashboard, null), document.getElementById('yith-wcmv-dashboard-root'));
}
})();
