<?php
/**
 * BuddyBoss - ReadyLaunch Create Meeting
 *
...
<div class="bb-rl-create-event-header">
	<h4 class="bb-title"><?php esc_html_e( 'Create Meeting', 'buddyboss-pro' ); ?></h2>
    <a class="bb-rl-close-create-meeting-form" href="#">
...
<div class="bb-rl-create-event-wrapper">
	...
	<footer class="text-right flex bb-rl-zoom-event-footer">
		...
		<a class="button submit bb-rl-button bb-rl-button--brandFill bb-rl-button--small" id="bp-zoom-meeting-form-submit" href="#"><?php esc_html_e( 'Create Meeting', 'buddyboss-pro' ); ?></a>
	</footer>
</div>
