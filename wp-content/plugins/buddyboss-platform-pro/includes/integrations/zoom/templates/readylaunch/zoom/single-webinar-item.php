<?php
/**
 * BuddyBoss - ReadyLaunch Groups Zoom Single Webinar
 *
...
<div class="webinar-item-container" data-id="<?php bp_zoom_webinar_id(); ?>" data-webinar-id="<?php bp_zoom_webinar_zoom_webinar_id(); ?>" data-is-recurring="<?php echo ( 'webinar_occurrence' === bp_get_zoom_webinar_zoom_type() || bp_get_zoom_webinar_recurring() ) ? '1' : '0'; ?>" <?php echo 'webinar_occurrence' === bp_get_zoom_webinar_zoom_type() ? 'data-occurrence-id="' . esc_attr( bp_get_zoom_webinar_occurrence_id() ) . '"' : ''; ?>>
	<div class="bb-title-wrap">
		<a href="#" class="bp-back-to-webinar-list"><span class="bb-icons-rl-caret-left"></span></a>
		<div>
			<h2 class="bb-title">
		...
		<?php if ( bp_zoom_groups_can_user_manage_zoom( bp_loggedin_user_id(), bp_get_current_group_id() ) && bp_zoom_groups_can_user_manage_webinar( bp_get_zoom_webinar_id() ) ) : ?>
			<div class="webinar-actions bb_more_options">
							...
							<li class="bp-zoom-webinar-edit">
								<?php if ( 'webinar_occurrence' === bp_get_zoom_webinar_zoom_type() ) : ?>
									<a role="button" id="bp-zoom-webinar-occurrence-edit-button" class="edit-webinar" href="#" data-id="bp-webinar-edit">
										<i class="bb-icons-rl-pencil-simple"></i><?php esc_html_e( 'Edit this Webinar', 'buddyboss-pro' ); ?>
									</a>
						...
						<li class="bp-zoom-webinar-delete">
							<?php if ( 'webinar_occurrence' === bp_get_zoom_webinar_zoom_type() ) : ?>
								<a role="button" id="bp-zoom-webinar-occurrence-delete-button" class="delete" href="#">
									<i class="bb-icons-rl-trash"></i><?php esc_html_e( 'Delete this Webinar', 'buddyboss-pro' ); ?>
								</a>
							...
							<?php else : ?>
								<a role="button" class="delete bp-zoom-delete-webinar" href="javascript:;"><i class="bb-icons-rl-trash"></i><?php esc_html_e( 'Delete this Webinar', 'buddyboss-pro' ); ?></a>
							<?php endif; ?>
						</li>
					</ul>
				</div>
	...
	<div id="bp-zoom-single-webinar" class="webinar-item webinar-item-table single-webinar-item-table" data-webinar-start-date="<?php echo esc_attr( wp_date( 'Y-m-d', strtotime( bp_get_zoom_webinar_start_date_utc() ), new DateTimeZone( bp_get_zoom_webinar_timezone() ) ) ); ?>">
		...
		<?php if ( ! $webinar_is_started ) : ?>
			<div class="single-webinar-item bb-countdown-wrap">
				<div class="meeting-item-head"><?php esc_html_e( 'When', 'buddyboss-pro' ); ?></div>
				...
				<?php if ( ! empty( bp_get_zoom_webinar_password() ) ) : ?>
					<div class="z-form-row-action">
						...
						<div class="pass-toggle">
							<a href="javascript:;" class="toggle-password show-pass on" aria-label="<?php esc_html_e( 'Show passcode', 'buddyboss-pro' ); ?>"><i class="bb-icons-rl-eye"></i></a>
							<a href="javascript:;" class="toggle-password hide-pass" aria-label="<?php esc_html_e( 'Hide passcode', 'buddyboss-pro' ); ?>"><i class="bb-icons-rl-eye-slash"></i></a>
						</div>
					</div>
				<?php else : ?>
			...
			<div class="single-webinar-item">
				...
				<div class="webinar-item-col">
					<div class="copy-link-wrap">
						...
						<a id="copy-invitation-link" class="edit copy-invitation-link bb-rl-button bb-rl-button--secondaryOutline bb-rl-button--small" href="#copy-invitation-popup" role="button" data-webinar-id="<?php bp_zoom_webinar_zoom_webinar_id(); ?>"><?php esc_html_e( 'View Invitation', 'buddyboss-pro' ); ?></a>
						...
						<div id="copy-invitation-popup" class="bzm-white-popup copy-invitation-popup mfp-hide">
							...
							<div id="webinar-invitation-container">
								<textarea id="webinar-invitation" readonly="readonly"><?php echo esc_html( bp_get_zoom_webinar_invitation( bp_get_zoom_webinar_zoom_webinar_id() ) ); ?></textarea>
							</div>

							<footer class="bb-zm-model-footer">
								<a href="#" id="copy-invitation-details" class="button small bb-rl-button bb-rl-button--brandFill bb-rl-button--small" data-copied-text="<?php esc_attr_e( 'Copied to clipboard', 'buddyboss-pro' ); ?>"><?php esc_html_e( 'Copy', 'buddyboss-pro' ); ?></a>
							</footer>
						</div>
					</div>
				</div>
		...
		<div class="single-webinar-item">
			...
			<div class="webinar-item-col">
				...
				<div class="bb-webinar-option <?php echo esc_attr( $bp_get_zoom_webinar_practice_session ); ?>">
					<i class="<?php echo bp_get_zoom_webinar_practice_session() ? esc_html( 'bb-icons-rl-check' ) : esc_html( 'bb-icons-rl-x' ); ?>"></i>
				...
				<div class="bb-webinar-option <?php echo esc_attr( $bp_get_zoom_webinar_authentication ); ?>">
					<i class="<?php echo bp_get_zoom_webinar_authentication() ? esc_html( 'bb-icons-rl-check' ) : esc_html( 'bb-icons-rl-x' ); ?>"></i>
				...
				<div class="bb-webinar-option <?php echo esc_attr( $bp_get_zoom_webinar_auto_recording ); ?>">
					<i class="<?php echo in_array( bp_get_zoom_webinar_auto_recording(), array( 'cloud', 'local' ), true ) ? esc_html( 'bb-icons-rl-check' ) : esc_html( 'bb-icons-rl-x' ); ?>"></i>
					<span>
						<?php
			...
			<div class="single-webinar-item last-col webinar-buttons-wrap">
				<div class="webinar-item-col webinar-action last-col full text-right">
					...
					if (
						...
						class="bb-rl-button bb-rl-button--secondaryOutline join-webinar-in-browser">
					...
					if (
						...
						?>
						<a type="button"
						class="bb-rl-button bb-rl-button--primary join-webinar-in-app"
						target="_blank"
