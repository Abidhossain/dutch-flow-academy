				...
				$cutomization_pg_array = apply_filters('evotix_settings_page_content', array(
					...
					array(
						...
						'fields'=>array(
							...
							array('id'=>'evotx_note',
								'type'=>'notice',
								'name'=>__('Event Tickets do NOT support Woocommerce Block cart and checkout at the moment.'),
								'legend'=> __('WC Block based cart and checkout are not supported at this moment, if you use these please switch to shortcode based cart and checkout pages for Tickets to function properly.')
							),
							...
							array('id'=>'evotx_restock','type'=>'begin_afterstatement'),
								...
								array(
									...
									'id'=>'evotx_restock_failed_gracetime',
									'type'=>'select',
									'name'=>'Select a grace period for restocking failed orders',
									'options'=> array(
										'0'=> __('Immediately','evotx'),
										'24'=> __('After 24 hours','evotx'),
										'48'=> __('After 48 hours','evotx'),
										'72'=> __('After 72 hours','evotx'),
									),
									'legend'=>'Setting a grace period for restocking the failed orders can avoid failed order payment getting cleared from customer bank account and becoming complete and selling the same ticket twice.',
								),
							...
							array('id'=>'subheader','type'=>'sub_section_open',
								...
								array(
									'id'=>'evotx_wc_prodname_link',
									'type'=>'yesno',
									'name'=> __('Disable product name linking to event page','evotx'),
									'legend'=> __('Stop product name being linked back to event page','evotx')
								),
					...
					array(
						...
						'fields'=>array(
							...
							// @2.2.9
							array('id'=>'evotx_autocomplete',
								'type'=>'yesno',
								'name'=> __('Enable auto complete ticket orders','evotx'),
								'legend'=> __('Activate various auto complete ticket orders setup. This will only run autocomplete for orders with tickets in them.','evotx'),
								'afterstatement'=>'evotx_autocomplete'
							),
							array('id'=>'evotx_autocomplete','type'=>'begin_afterstatement'),
								array(
									'id'=>'evotx_autocomplete_type', 
									'type'=>'checkboxes',
									'name'=>__('Select relevent auto complete ticket order type','evotx'),
									'options'=> array(
										//'paid'=>__('Auto complete ticket orders upon successful payment','evotx'),
										'rpay'=>__('Auto complete regardless of payment status','evotx'),
										'bacs'=>__('Auto complete direct bank transfer payment methods','evotx'),
										'cod'=>__('Auto complete cash on delivery payment methods','evotx'),
										'cheque'=>__('Auto complete check payment methods','evotx'),
									)
								),	

							array('id'=>'evotx_autocomplete','type'=>'end_afterstatement'),		
					...
					array(
						...
						'fields'=>array(
							...
							array(
								'id'=>'evotx_hide_email_tix_holder',
								'type'=>'yesno',
								'name'=>'Hide ticket holder details from showing in Woo emails',
								'legend'=>__('Hide the ticket holder details from showing in woocommerce generate emails.','evotx')
							),
