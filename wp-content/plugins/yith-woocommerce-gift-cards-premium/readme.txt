...
= 4.27.0 - Released on 6 August 2025 =

* New: support for WooCommerce 10.1
* Update: YITH plugin framework
* Dev: added new filter yith_ywgc_hide_expiration_date_gift_this_product

= 4.26.0 - Released on 3 July 2025 =

* New: support for WooCommerce 10.0
* Update: YITH plugin framework
* Fix: convert dates correctly when importing the gift cards
...
* Update: YITH plugin framework
* Dev: improved conditions to only allow using the "Gift this product" feature for bookable products created with YITH Booking and Appointment for WooCommerce

= 4.24.0 - Released on 23 April 2025 =

* New: support for WordPress 6.8
* Update: YITH plugin framework

= 4.23.0 - Released on 18 March 2025 =

* New: support for WooCommerce 9.8
* Update: YITH plugin framework
* Dev: improved gift card price verification when adding to cart
* Dev: validate nonce correctly when generating the gift cards in bulk

= 4.22.0 - Released on 12 February 2025 =

* New: support for WooCommerce 9.7
* Update: YITH plugin framework
* Fix: prevent the display of unsent gift cards in My Account

= 4.21.0 - Released on 21 January 2025 =

* New: support for WooCommerce 9.6
* Update: YITH plugin framework
* Fix: operand types when processing the gift card delivery date

= 4.20.0 - Released on 24 December 2024 =

* New: support for WooCommerce 9.5
* Update: YITH plugin framework
* Dev: added new filter yith_ywgc_apply_gift_card_to_cart_target
* Dev: added $gift_card parameter to yith_ywgc_bcc_additional_recipients filter
* Dev: added new filter yith_ywgc_add_new_gift_card_my_account_error_condition

= 4.19.2 - Released on 21 November 2024 =

* Update: YITH plugin framework
* Fix: fixed link to download the selected design from the order item meta
* Fix: fixed issues with the temp directory required by MPDF

= 4.19.1 - Released on 12 November 2024 =

* Update: YITH plugin framework
* Dev: added missing check for the gift cards redemption in the gift cards table
* Dev: downgrading MPDF to version 8.0.5 as the PSR/Log 3.0 required by the latest version is not compatible with PHP below 8.0
* Dev: added new filter yith_ywgc_create_cron_on_code_post_save
* Dev: added a new filter yith_ywgc_show_download_link_in_physical_gift_cards_order_itemmeta

= 4.19.0 - Released on 6 November 2024 =

* New: support for WordPress 6.7
* New: support for WooCommerce 9.4
* Update: YITH plugin framework
* Update: French translation
* Fix: save gift card code correctly for pre-printed gift cards
* Fix: fixed name in the minimal cart total option
* Dev: removed legacy use of the gift card product image metas
* Dev: don't save the _yith_wcgc_disable_gift_this_product meta for not allowed product types
* Dev: changed the discount field from text to number in the gift card product edit page, adding min/max restriction to the field
* Dev: deleted meta ywgc_pdf_file when the file is deleted
* Dev: removed YWGC_GIFT_CARD_LAST_VIEWED_ID constant
* Dev: deleted the hidden button to update the legacy cron
* Dev: include the addons price in the cart with the WPML integration
* Dev: updated mPDF to 8.2.1 and all the libraries
* Dev: removed unused code related to the legacy fees
* Dev: deleted unused options

= 4.18.0 - Released on 5 September 2024 =

* New: support for WooCommerce 9.3
* Update: YITH plugin framework

= 4.17.0 - Released on 21 August 2024 =

* New: support for WooCommerce 9.2
* Update: YITH plugin framework
* Fix: fixed the gift card amount conversion in the cart and checkout when using WPML
* Dev: register shortcode styles for the Elementor widgets
* Dev: added some RTL styles in the product page, provided by community
* Dev: minor style changes
* Dev: minor core changes

= 4.16.0 - Released on 17 July 2024 =

* New: support for WooCommerce 9.1
* New: support for WordPress 6.6
* Update: YITH plugin framework
* Fix: remove the custom amount error message when success
* Dev: moved 'product_type_selector' filter to a common class

= 4.15.0 - Released on 28 June 2024 =

* Update: YITH plugin framework
* Fix: fixed wrong expiration dates
* Dev: added new filter yith_ywgc_show_gift_card_add_to_cart_button_is_purchasable
* Dev: updated the filters ywgc_execute_woocommerce_update_order and ywgc_woocommerce_order_needs_payment to false by default
* Dev: added new filter yith_ywgc_gift_card_status_export
* Dev: adding calendar icon to the datepickers in backend
* Dev: added new filter yith_ywgc_gift_card_addon_label
* Dev: minor changes

= 4.14.0 - Released on 03 June 2024 =

* New: support for WooCommerce 9.0
* Update: YITH plugin framework
* Fix: fixed the delivery date in the Gift this product
* Fix: fixed the Smart Coupons import option
* Dev: added new filter ywgc_calendar_time_format
* Dev: added new filter ywgc_woocommerce_order_needs_payment
* Dev: added new filter yith_ywgc_gift_card_addon_value
* Dev: minor changes
...
* Update: YITH plugin framework
* Fix: fixed the minimum amount error handling
* Fix: fixed vulnerability due to a missing capability check on the 'save_mail_status' and 'save_email_settings'
* Dev: added new filter ywgc_execute_woocommerce_update_order
* Dev: adding the button type to the gift card amounts

= 4.12.3 - Released on 25 April 2024 =

* Update: YITH plugin framework
* Fix: fixed delivery date offset calculation
* Fix: replaced the deprecated Google QR Code generator by QuickChart
* Fix: error redeeming gift card when original product was deleted
* Dev: added new filter yith_ywgc_gift_card_code_total_row
* Dev: prevent the shipping cost to change when applying a gift card code
* Dev: minor changes

= 4.12.2 - Released on 08 April 2024 =
...
= 4.12.1 - Released on 03 April 2024 =

* Update: YITH plugin framework
* Fix: fixed composer issues

= 4.12.0 - Released on 02 April 2024 =
...
= 4.11.0 - Released on 26 March 2024 =
...
= 4.10.0 - Released on 20 February 2024 =
...
= 4.9.0 - Released on 26 January 2024 =
...
* Update: YITH plugin framework
* Updated: updated French translation by community
...
= 4.5.0 - Released on 05 October 2023 =
...
= 4.4.0 - Released on 06 September 2023 =

* New: support for WooCommerce 8.1
* Update: YITH plugin framework
* Fix: fixed issue with the default shipping value in the gift this product
* Fix: fixed the shipping cost section in the "gift this product"
* Dev: fixed wrong string domains
* Dev: minor change to avoid the gift this product preview displayed in the normal gift cards
* Dev: minor changes

= 4.3.0 - Released on 09 August 2023 =

* New: support for WooCommerce 8.0
* New: support for WordPress 6.3
* Update: YITH plugin framework
* Fix: fixed the variation amount not being updated on the Gift this product feature
* Dev: use a custom template for the Gift this Product instead of the product shortcode
* Dev: compatibility with WC Blocks
* Dev: minor changes

= 4.2.0 - Released on 07 July 2023 =

* New: support for WooCommerce 7.9
* Update: YITH plugin framework
* Dev: minor change to prevent the multiple generation of default products
* Dev: initialize the YWGC_PRODUCT_PLACEHOLDER option if doesn't exist

= 4.1.4 - Released on 30 June 2023 =

* Update: YITH plugin framework
* Fix: fixed issue with the duplicated gift this products
* Dev: minor changes

= 4.1.3 - Released on 28 June 2023 =

* Update: YITH plugin framework
* Dev: added a condition to not generate the default product if the "Gift this product" module is disabled

= 4.1.2 - Released on 26 June 2023 =

* Update: YITH plugin framework
* Dev: removed the "quick edit" and "duplicate" actions in the default product
* Dev: double-check the default product creation to avoid duplications
* Dev: minor changes

= 4.1.1 - Released on 22 June 2023 =

* Update: YITH plugin framework
* Dev: force the legacy cron job to be removed
* Dev: improving the Gift this Product with some fixes and changes
* Dev: prevent the edition of critical information in the default Gift this product

= 4.1.0 - Released on 19 June 2023 =

* New: support for WooCommerce 7.8
* Tweak: added new filter in the gift cards table to display the disabled gift cards
* Update: YITH plugin framework
* Fix: incorrect balance in Gift Cards list when using Multi-Currency
* Fix: prevent the product tabs to be displayed in the Gift this product modal
* Fix: wrong date format in the gift cards export
* Fix: Solved an issue where the initial amount is updated each time the custom amount is updated
* Dev: Disable the tabs and related products for the default gift this product
* Dev: minor changes
* Dev: move the gift card categories options inside the settings

= 4.0.1 - Released on 29 May 2023 =

* Update: YITH plugin framework
* Fix: Aelia compatibility
* Fix: display of the custom image uploaded in the gift card PDF
* Fix: gift card custom amount selection
* Fix: upload of the custom image with the version 1 of the product page layout
* Dev: added wp-util as a dependency for the frontend scripts
* Dev: minor fixes and checks in the code
...
* New: added the "Gift this product" feature as a modal in the product pages
* New: option to set or replace a gift card image in the code edit page
* New: added a option to select the layout for the gift card product page
* New: added a new layout for the gift card product page
* New: added a drag and drop upload for the custom images uploaded by the customer
* New: added the image gallery for the physical gift cards
* New: integration with YITH Booking and Appointment for WooCommerce
* New: option to show or not the gift card product price on the product page
* Tweak: improved the settings panel
* Tweak: improved the "Gift this product" feature
...
* Tweak: improved the Export/Import settings
* Tweak: minor style changes
* Update: YITH plugin framework
* Update: plugin official languages
...
* Dev: remove the legacy cron job


= 3.24.0 - Released on 9 March 2023 =
...
= 3.23.1 - Released on 27 February 2023 =
...
= 3.23.0 - Released on 14 February 2023 =
...
= 3.22.0 - Released on 03 January 2023 =
...
= 3.21.0 - Released on 05 December 2022 =
...
= 3.20.1 - Released on 15 November 2022 =
...
= 3.20.0 - Released on 03 November 2022 =
...
* Dev: added yith_wcgc_param_array_format_price filter
...
= Version 3.5.1 - Released: September 27, 2021 =
...
* Fix: added a condition to prevent errors when the product purchased as a gift has beeen deleted
